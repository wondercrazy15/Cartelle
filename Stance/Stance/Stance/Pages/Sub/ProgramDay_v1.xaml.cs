...
{
    public partial class ProgramDay_v1 : ContentPage
    {
        ...
        private async void OpenExerciseVideo(ExerciseVideoPlayerCell e)
        {
           ...
           // await MyScrollView.ScrollToAsync(e.videoSL, ScrollToPosition.Center, true);
        ...
        async void InboxBtn_Clicked(object sender, System.EventArgs e)
        {
            await Navigation.PushModalAsync(new MessageCentrePage());
        }
