...
namespace Stance.Models
{
    public class VideoPlayer : View, IVideoPlayerController
    {
        ...
        public bool AutoPlay
        {
            ...
            public static readonly BindableProperty FillModeProperty =
            BindableProperty.Create(nameof(FillMode), typeof(string), typeof(VideoPlayer), "Resize");

        public string FillMode
        {
            set { SetValue(AutoPlayProperty, value); }
            get { return (string)GetValue(FillModeProperty); }
        }
